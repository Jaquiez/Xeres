...
public class CustomCharacterManager : MonoBehaviour
{
    ...
    private void setStatPoint(CreateStat type, int pt)
    {
        ...
        //Xeres Custom Tweak
        this.setup.myCostume.stat.SPD = Mathf.Clamp(this.setup.myCostume.stat.SPD, 75, 140);
        this.setup.myCostume.stat.GAS = Mathf.Clamp(this.setup.myCostume.stat.GAS, 50, 150);
        this.setup.myCostume.stat.BLA = Mathf.Clamp(this.setup.myCostume.stat.BLA, 50, 125);
        this.setup.myCostume.stat.ACL = Mathf.Clamp(this.setup.myCostume.stat.ACL, 75, 150);
        /*
