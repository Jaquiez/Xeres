...
public class FengGameManagerMKII : Photon.MonoBehaviour
{
    ...
    public int wave = 1;
    private static GameObject XeresUIManager;
    ...
    {
        Xeres.Tools.XeresScoreboard.sortPlayerList();
        /*
        int num15;
        string str3;
        int num16;
    ...
    public void OnGUI()
    {
        if (!GUI.skin.name.Equals("yo mama"))
        {
            GUI.skin = XeresStyle.GetGUISkin();
            //textureBackgroundBlack = GUI.skin.box.normal.background;
            //textureBackgroundBlue = GUI.skin.box.normal.background;
        }
    ...
    public void OnJoinedRoom()
    {
        ...
        Xeres.UserPrefs.PropertyHandler handler = GameObject.Find("XeresManager").GetComponent<Xeres.UserPrefs.PropertyHandler>();
        ExitGames.Client.Photon.Hashtable hashtable = new ExitGames.Client.Photon.Hashtable();
        ...
        hashtable.Add("Xeres", "yo mama perhaps");
        hashtable.Add(XeresProperty.infiniteGas, RCextensions.returnBoolFromObject(handler.XeresPropeties[XeresProperty.infiniteGas]));
        hashtable.Add(XeresProperty.infiniteBlades, RCextensions.returnBoolFromObject(handler.XeresPropeties[XeresProperty.infiniteBlades]));
        hashtable.Add(XeresProperty.infiniteAHSS, RCextensions.returnBoolFromObject(handler.XeresPropeties[XeresProperty.infiniteAHSS]));
        ExitGames.Client.Photon.Hashtable propertiesToSet = hashtable;
        PhotonNetwork.player.SetCustomProperties(propertiesToSet);
        this.humanScore = 0;
        this.titanScore = 0;
...
//         }
    ...
    public void restartRC()
    {
        ...
        //chatRoom.scrollPosition.y = int.MaxValue;
    }
    ...
    private void Start()
    {
        ...
        if (this.textureBackgroundBlack == null)
        {
            ...
            this.textureBackgroundBlack.SetPixel(0, 0, new Color(2f / 256, 35 / 256, 42 / 256, .75f));
        ...
        if (this.textureBackgroundBlue == null)
        {
            ...
            this.textureBackgroundBlue.SetPixel(0, 0, new Color(.1f,.1f,.1f,.5f));
