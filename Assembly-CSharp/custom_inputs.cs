...
public class custom_inputs : MonoBehaviour
{
    ...
    {
        float y = this.Boxes_Y;
        float x = Input.mousePosition.x;
        float num3 = Input.mousePosition.y;
        Vector3 point = GUI.matrix.inverse.MultiplyPoint3x4(new Vector3(x, Screen.height - num3, 1f));
        ...
        GUI.Label(new Rect(this.DescriptionBox_X, y - 10f, (float) this.DescriptionSize, this.buttonHeight), "name", "textfield");
        GUI.Label(new Rect(this.InputBox1_X, y - 10f, (float) this.DescriptionSize, this.buttonHeight), "input", "textfield");
        GUI.Label(new Rect(this.InputBox2_X, y - 10f, (float) this.DescriptionSize, this.buttonHeight), "alt input", "textfield");
        for (int i = 0; i < this.DescriptionString.Length; i++)
        {
            y += this.BoxesMargin_Y;
            GUI.Label(new Rect(this.DescriptionBox_X, y, (float) this.DescriptionSize, this.buttonHeight), this.DescriptionString[i], "box");
            Rect position = new Rect(this.InputBox1_X, y, (float) this.buttonSize, this.buttonHeight);
    ...
    private void drawButtons2()
    {
        ...
        {
            y += this.BoxesMargin_Y;
            Rect position = new Rect(this.InputBox2_X, y, (float) this.buttonSize, this.buttonHeight);
