...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    {
        if ((FengGameManagerMKII.OnPrivateServer || !MasterServerAddress.StartsWith("app-")) && MasterServerAddress != null && MasterServerAddress != string.Empty && mGameserver != null && mGameserver != string.Empty && MasterServerAddress.Contains(":") && mGameserver.Contains(":"))
        {
